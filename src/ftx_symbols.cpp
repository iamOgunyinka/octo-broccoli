...
void ftx_symbols::sendNetworkRequest(
    QString const &url, trade_type_e const expectedTradeType,
    success_callback_t onSuccess, error_callback_t onError)
{
...
void ftx_symbols::getSpotsExchangeInfo(
    token_list_t* spotsContainerPtr,
    error_callback_t onError) {
}

void ftx_symbols::getFuturesExchangeInfo(
    token_list_t* spotsContainerPtr,
    error_callback_t onError) {
}
